                ...
                <div className="flex gap-4">
                    <TooltipProvider>
                        ...
                        >
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Link href="https://www.linkedin.com/in/aditya-hirpara-39a34429a/" target="_blank">
                        ...
                        >
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Link href="https://github.com/hirpadii07" target="_blank">
                                        <Button variant="secondary" size="icon">
                                            <Github />
                                        </Button>
                                    </Link>
                        ...
                        >
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Link href="mailto:hirpaa7@hotmail.com" target="_blank">
                                        <Button variant="secondary" size="icon">
                                            <AtSign />
                                        </Button>
                                    </Link>
